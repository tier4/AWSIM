...
It can move on roads, more specifically `TrafficLanes`, thanks to the use of `TrafficSimulator` - which you can read more about [here](../../../Components/Environment/TrafficComponents/).

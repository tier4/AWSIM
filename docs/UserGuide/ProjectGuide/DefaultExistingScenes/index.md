...
The `NPCPedestrianSample` was developed to conduct a quick test for the developed pedestrian. Replace the NPC prefab in `NPC Pedestrian Test` script with a prefab you developed and check if the basic things are configured correctly.
...
The `TrafficLightSample` was developed to conduct a quick test for the developed model of lights in cooperation with the script controlling them. Replace the lights and configuration with your own and check that it works correctly. 

...
1. Create [issue](https://github.com/autowarefoundation/AWSIM/issues). and mention `@mackierx111`.
1. Once the implementation policy has been decided, create a working branch from the `main` branch
1. Create [pull request](https://github.com/autowarefoundation/AWSIM/pulls).
1. **Be sure to self-check before requesting a review. The checklist items are as follows.**
    ...
    - Understand [AWSIM License](https://github.com/autowarefoundation/AWSIM/blob/main/LICENSE) and agree that it applies to your contribution.
1. Create a pull request and submit it to `@mackierx111` for review.

## License applicability during contributions
[AWSIM License](https://github.com/autowarefoundation/AWSIM/blob/main/LICENSE) applies to all contributions to `AWSIM`.<br>
Before contributing, please read [LICENSE](https://github.com/autowarefoundation/AWSIM/blob/main/LICENSE) and understand that it applies to your contribution.

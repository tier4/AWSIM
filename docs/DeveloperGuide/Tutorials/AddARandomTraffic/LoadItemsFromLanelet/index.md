...
1. Configure is selection of a Traffic Light.
    ...
    You need to select one only when the Stop Line is right in front of a [Traffic Intersection](../../../../UserGuide/ProjectGuide/Components/Environment/TrafficSimulation/) that has a Traffic Lights.

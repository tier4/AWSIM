...
[AwsimRos2Node](https://github.com/autowarefoundation/AWSIM/blob/docs/ROS2_modify/Assets/Awsim/Scripts/Common/Ros2/AwsimRos2Node.cs) static class is a ROS2 node that can be commonly used in AWSIM. The design of AwsimRos2Node provides the following advantages.

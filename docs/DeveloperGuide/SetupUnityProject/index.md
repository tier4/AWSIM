...
!!! info
    ...
    AWSIM's Unity version is currently **6000.0.61f1**

1. Install [UnityHub](https://docs.unity3d.com/hub/manual/InstallHub.html).
1. Download Unity 6000.0.61f1 from the [download archive](https://unity.com/releases/editor/archive).
...
1. Open AWSIM project.
    ...
    ```bash  
    ~/Unity/Hub/Editor/6000.0.61f1/Editor/Unity -projectPath "/home/user/AWSIM/"
    ```
    ...
    !!! info
        ...
        ```bash
        cd ~/Unity/Hub/Editor/6000.0.61f1/Editor/
        mv Unity Unity.bin
...
1. Download `Shinjuku.unitypackage`
    ...
    [Download Shinjuku.unitypackage](https://github.com/autowarefoundation/AWSIM/releases/download/v2.0.0/Shinjuku.unitypackage){ .md-button }

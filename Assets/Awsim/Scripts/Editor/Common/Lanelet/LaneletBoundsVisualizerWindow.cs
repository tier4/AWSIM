...
namespace Awsim.Common.Editor
{
    public class LaneletBoundsVisualizerWindow : EditorWindow
    {
        ...
        [SerializeField] GameObject _holderGameObject;
        private SerializedObject serializedObject;

        [MenuItem("AWSIM/Common/LaneletBoundsVisualizer")]
        ...
        private void OnGUI()
        {
            ...
            var holderGameObjectProperty = serializedObject.FindProperty("_holderGameObject");
            EditorGUILayout.PropertyField(holderGameObjectProperty, true);
            ...
            if (GUILayout.Button("Load with Waypoint Setting"))
            {
                ...
                loader.Load(osm.Data, referencePoint, _holderGameObject, false);
            }
            else if (GUILayout.Button("Load Raw Data"))
            {
                ...
                loader.Load(osm.Data, referencePoint, _holderGameObject, true);
            }
        }
    }
}

...
namespace RGLUnityPlugin
{
    ...
    public class LidarSensor : MonoBehaviour
    {
        ...
        /// <summary>
        /// Allows to quickly enable/disable ground filtering
        /// </summary>
        public bool applyGroundFiltering = false;
        ...
        private const string compactByFieldNodeId = "POINTS_COMPACT_BY_GROUND";
        ...
        private void ApplyConfiguration(LidarConfiguration newConfig)
        {
            ...
            rglGraphLidar.UpdateNodeRaysFromMat3x4f(lidarRaysNodeId, newConfig.GetRayPoses())
                         ...
                         .UpdateNodePointsFilterGround(filterGroundNodeId, groundFilteringAngleThreshold * Mathf.Deg2Rad)
            ...
            rglGraphLidar.SetActive(filterGroundNodeId, applyGroundFiltering);
            rglGraphLidar.SetActive(compactByFieldNodeId, applyGroundFiltering);

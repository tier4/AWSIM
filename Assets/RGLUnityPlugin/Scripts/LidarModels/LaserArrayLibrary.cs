...
namespace RGLUnityPlugin
{
    public static class LaserArrayLibrary
    {
        ...
        public static LaserArray OusterOS1_64 => new LaserArray
        {
            ...
            lasers = new[]
            {
                new Laser {horizontalAngularOffsetDeg = 3.057f, verticalAngularOffsetDeg = -16.352001f, ringId = 1},
                new Laser {horizontalAngularOffsetDeg = 0.921f, verticalAngularOffsetDeg = -15.772f, ringId = 2},
                new Laser {horizontalAngularOffsetDeg = -1.188f, verticalAngularOffsetDeg = -15.218999f, ringId = 3},
                new Laser {horizontalAngularOffsetDeg = -3.313f, verticalAngularOffsetDeg = -14.684999f, ringId = 4},
                new Laser {horizontalAngularOffsetDeg = 3.051f, verticalAngularOffsetDeg = -14.191001f, ringId = 5},
                ...
                new Laser {horizontalAngularOffsetDeg = 3.044f, verticalAngularOffsetDeg = -12.071999f, ringId = 9},
                ...
                new Laser {horizontalAngularOffsetDeg = -3.204f, verticalAngularOffsetDeg = -10.467999f, ringId = 12},
                new Laser {horizontalAngularOffsetDeg = 3.042f, verticalAngularOffsetDeg = -9.9820013f, ringId = 13},
                new Laser {horizontalAngularOffsetDeg = 0.954f, verticalAngularOffsetDeg = -9.4350004f, ringId = 14},
                new Laser {horizontalAngularOffsetDeg = -1.105f, verticalAngularOffsetDeg = -8.8959999f, ringId = 15},
                new Laser {horizontalAngularOffsetDeg = -3.168f, verticalAngularOffsetDeg = -8.3799992f, ringId = 16},
                new Laser {horizontalAngularOffsetDeg = 3.044f, verticalAngularOffsetDeg = -7.9029999f, ringId = 17},
                new Laser {horizontalAngularOffsetDeg = 0.986f, verticalAngularOffsetDeg = -7.368f, ringId = 18},
                new Laser {horizontalAngularOffsetDeg = -1.082f, verticalAngularOffsetDeg = -6.8449998f, ringId = 19},
                new Laser {horizontalAngularOffsetDeg = -3.135f, verticalAngularOffsetDeg = -6.3119998f, ringId = 20},
                new Laser {horizontalAngularOffsetDeg = 3.047f, verticalAngularOffsetDeg = -5.8400006f, ringId = 21},
                new Laser {horizontalAngularOffsetDeg = 0.995f, verticalAngularOffsetDeg = -5.3060002f, ringId = 22},
                new Laser {horizontalAngularOffsetDeg = -1.064f, verticalAngularOffsetDeg = -4.7710004f, ringId = 23},
                new Laser {horizontalAngularOffsetDeg = -3.106f, verticalAngularOffsetDeg = -4.2509999f, ringId = 24},
                new Laser {horizontalAngularOffsetDeg = 3.071f, verticalAngularOffsetDeg = -3.7790003f, ringId = 25},
                new Laser {horizontalAngularOffsetDeg = 1.013f, verticalAngularOffsetDeg = -3.24f, ringId = 26},
                new Laser {horizontalAngularOffsetDeg = -1.036f, verticalAngularOffsetDeg = -2.714f, ringId = 27},
                new Laser {horizontalAngularOffsetDeg = -3.082f, verticalAngularOffsetDeg = -2.1889999f, ringId = 28},
                new Laser {horizontalAngularOffsetDeg = 3.080f, verticalAngularOffsetDeg = -1.7170001f, ringId = 29},
                new Laser {horizontalAngularOffsetDeg = 1.031f, verticalAngularOffsetDeg = -1.1869999f, ringId = 30},
                new Laser {horizontalAngularOffsetDeg = -1.016f, verticalAngularOffsetDeg = -0.64999992f, ringId = 31},
                ...
                new Laser {horizontalAngularOffsetDeg = 1.048f, verticalAngularOffsetDeg = 0.87400001f, ringId = 34},
                new Laser {horizontalAngularOffsetDeg = -1.008f, verticalAngularOffsetDeg = 1.405f, ringId = 35},
                new Laser {horizontalAngularOffsetDeg = -3.062f, verticalAngularOffsetDeg = 1.9360001f, ringId = 36},
                new Laser {horizontalAngularOffsetDeg = 3.114f, verticalAngularOffsetDeg = 2.4060001f, ringId = 37},
                new Laser {horizontalAngularOffsetDeg = 1.066f, verticalAngularOffsetDeg = 2.937f, ringId = 38},
                new Laser {horizontalAngularOffsetDeg = -0.995f, verticalAngularOffsetDeg = 3.4660001f, ringId = 39},
                new Laser {horizontalAngularOffsetDeg = -3.055f, verticalAngularOffsetDeg = 4.0019999f, ringId = 40},
                new Laser {horizontalAngularOffsetDeg = 3.134f, verticalAngularOffsetDeg = 4.4720001f, ringId = 41},
                new Laser {horizontalAngularOffsetDeg = 1.076f, verticalAngularOffsetDeg = 4.9989996f, ringId = 42},
                new Laser {horizontalAngularOffsetDeg = -0.980f, verticalAngularOffsetDeg = 5.5300002f, ringId = 43},
                new Laser {horizontalAngularOffsetDeg = -3.052f, verticalAngularOffsetDeg = 6.066f, ringId = 44},
                new Laser {horizontalAngularOffsetDeg = 3.156f, verticalAngularOffsetDeg = 6.5380001f, ringId = 45},
                new Laser {horizontalAngularOffsetDeg = 1.099f, verticalAngularOffsetDeg = 7.0630002f, ringId = 46},
                new Laser {horizontalAngularOffsetDeg = -0.972f, verticalAngularOffsetDeg = 7.5970001f, ringId = 47},
                new Laser {horizontalAngularOffsetDeg = -3.031f, verticalAngularOffsetDeg = 8.1440001f, ringId = 48},
                new Laser {horizontalAngularOffsetDeg = 3.175f, verticalAngularOffsetDeg = 8.6120005f, ringId = 49},
                new Laser {horizontalAngularOffsetDeg = 1.110f, verticalAngularOffsetDeg = 9.1370001f, ringId = 50},
                new Laser {horizontalAngularOffsetDeg = -0.959f, verticalAngularOffsetDeg = 9.6719999f, ringId = 51},
                ...
                new Laser {horizontalAngularOffsetDeg = 1.140f, verticalAngularOffsetDeg = 13.320999f, ringId = 58},
                new Laser {horizontalAngularOffsetDeg = -0.963f, verticalAngularOffsetDeg = 13.86f, ringId = 59},
                new Laser {horizontalAngularOffsetDeg = -3.066f, verticalAngularOffsetDeg = 14.422999f, ringId = 60},

...
namespace AWSIM
{
    ...
    public class EZ10VehicleVisualEffect : MonoBehaviour
    {
        [Serializable]
        ...
        void Update()
        {
            ...
            bool IsBrakeLight()
            {
                return (vehicle.AutomaticShiftInput == EZ10Vehicle.Shift.DRIVE && vehicle.AccelerationInput < 0)
                    || (vehicle.AutomaticShiftInput == EZ10Vehicle.Shift.REVERSE && vehicle.AccelerationInput < 0);
            }

            bool IsReverseLight()
            {
                return vehicle.AutomaticShiftInput == EZ10Vehicle.Shift.REVERSE;
            }

            bool IsTurnSignalOn()
            {
                return ((vehicle.SignalInput == EZ10Vehicle.TurnSignal.LEFT)
            ...
            {
                return ((vehicle.SignalInput == EZ10Vehicle.TurnSignal.RIGHT)
                    || (vehicle.SignalInput == EZ10Vehicle.TurnSignal.HAZARD))
                    && turnSignalOn;
            }

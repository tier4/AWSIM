...
namespace AWSIM
{
    ...
    /// </summary>
    public class EZ10VehicleReportRos2Publisher : MonoBehaviour
    {
        /// <summary>
        ...
        void FixedUpdate()
        {
            ...
            // GearReport
            gearReportMsg.Report = EZ10VehicleROS2Utility.UnityToRosShift(vehicle.AutomaticShiftInput);

            // SteeringReport
            steeringReportMsg.Steering_tire_angle = -1 * vehicle.SteerAngle * Mathf.Deg2Rad;

            // TurnIndicatorsReport
            turnIndicatorsReportMsg.Report = EZ10VehicleROS2Utility.UnityToRosTurnSignal(vehicle.SignalInput);

            // HazardLightsReport
            hazardLightsReportMsg.Report = EZ10VehicleROS2Utility.UnityToRosHazard(vehicle.SignalInput);
